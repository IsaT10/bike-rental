...
exports.getSingleBike = exports.deleteBike = exports.updateBike = exports.getAllBike = exports.createBike = void 0;
...
const getSingleBike = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const data = yield (0, bike_service_1.getSingleBikeFromDB)(id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
